...
// This file is copied from PInvokeTableGenerator.cs in the runtime repo, with minimal changes to allow
// invoking its individual parts ("collect pinvokes" and "emit table") separately so it can be made
// properly incremental. Later on we should change the runtime's PInvokeTableGenerator to be properly
// incremental as this will make all WebAssembly native builds faster by about 4 seconds.
